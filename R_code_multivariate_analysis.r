...
#misura della varaibilita su una variabile, qunid si deve scegliere una delle bande 
#per scegliere la migliore o uso una banda di cui ho fiducia (es. NIR) oppure mi calccolo gli indici spettrali
...
#se io mi trovo nella bi dimensione non concepisco le terza ma non è detto che degli elemnti non lo siano solo
